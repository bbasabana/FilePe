        ...
        >
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-white/10 bg-surface-overlay px-4 py-3 text-ink-primary placeholder:text-ink-tertiary focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
